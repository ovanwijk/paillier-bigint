...
//   // key1 = _pkg.keysFromPrimesSimple(key1.privateKey._p, key1.privateKey._q)// 3072
//   // key2 = _pkg.keysFromPrimesSimple(key2.privateKey._p, key2.privateKey._q)// 3072
//   var key1 = _pkg.keysFromPrimesSimple(65543n, 53161n)
//   var key2 = _pkg.keysFromPrimesSimple(93523n, 36931n)

//   var commonG = _pkg.generateDualG(bcu.max(key1.publicKey.n, key2.publicKey.n), bcu.min(key1.publicKey._n2, key2.publicKey._n2))
//   console.log('var key1 = _pkg.keysFromPrimesSimple(' + key1.privateKey._p + 'n, ' + key1.privateKey._q + 'n )')
//   console.log('var key2 = _pkg.keysFromPrimesSimple(' + key2.privateKey._p + 'n, ' + key2.privateKey._q + 'n )')
//   console.log('CommonG', commonG)
//   commonG = 1390926272n
...
//   var g2 = 22466603n
//   var multiplier = 10n// bcu.randBetween(max_N, max_N / 2n)// 115042541n //1577390195004483534n
//   var addition = 100n
//   var start_value = 10n // bcu.randBetween(max_N/ 2n, max_N / 4n)//115042541n //10343936545358346415n
//   var encrypted1 = key1.publicKey.encrypt(start_value, commonG)
//   var encrypted2 = key1.publicKey.encrypt(start_value, commonG)
//   console.log(commonG, key1.privateKey.getRandomFactor(encrypted1), key1.privateKey.getRandomFactor(encrypted2))
//   encrypted1 = key1.publicKey.addition(encrypted1, key1.publicKey.encrypt(addition, commonG))

//   encrypted2 = key1.publicKey.multiply(encrypted2, multiplier)// _pkg.multiplyOtherN2(encrypted2, multiplier, key1.publicKey._n2);
//   encrypted2 = key1.publicKey.addition(encrypted2, key1.publicKey.encrypt(multiplier, commonG))

//   var dec1 = key1.privateKey.decrypt(encrypted1)
//   var dec2 = key1.privateKey.decrypt(encrypted2)
//   console.log('Addition', encrypted1)
//   console.log('Multipli', encrypted2)
